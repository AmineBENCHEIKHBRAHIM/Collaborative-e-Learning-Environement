...
padding: 0.8em 2em;box-sizing: border-box;">
       <a href="repgroupeindiv.jsp?idprob=<%=idprob%>&poseur=<%=poseur%>&o=<%=objectif%>&t=<%=tache%>&a=<%=artefact%>&c=<%=contrainte%>&user=<%=session.getAttribute("iduser")%>&n=<%=note%>&i=<%=i%>">Problème <%= i %> :</a> By <%=poseur %> <br>
