	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.print(contrainte);
		   ...
		   try {
				...
				query = "insert into probindiv (idposeur,idgroupe,objectif,tache,artefact,contrainte) values('"+poseur+"','"+idgrp+"','"+objectif+"','"+tache+"','"+artefact+"','"+contrainte+"')";
		...
		RequestDispatcher rd = request.getRequestDispatcher("DisplayProbIndiv");
