...
padding: 0.8em 2em;box-sizing: border-box;">
       <a href="repgroupecoll.jsp?idprob=<%=idprob%>&poseur=<%=poseur%>&o=<%=objectif%>&t=<%=tache%>&a=<%=artefact%>&c=<%=contrainte%>&user=<%=session.getAttribute("iduser")%>&i=<%=i%>">Problème <%= i %> :</a> By <%=poseur %> <br>
...
<br><hr>
     ...
     <form method="post" action="AjoutProbColl" name="productForm" style="background: none repeat scroll 0% 0% rgba(255, 255, 255, 0.15);border-style: none solid solid;border-width: 0px 1px 1px;border: 1px solid #C2C7CC;
border-color: -moz-use-text-color rgba(255, 255, 255, 0.5) rgba(255, 255, 255, 0.5);color: #FFF;display: inline-block;transition: color 0.25s ease-in-out 0s, border-color 0.25s ease-in-out 0s, background-color 0.25s ease-in-out 0s;
text-decoration: none;
border-radius: 0.35em;
padding: 0.8em 2em;box-sizing: border-box;">
    <select name="objectif">
        ...
        <option value="Realisation">Réalisation
        <option value="Tests">Tests
    </select>
    <select name="tache">
        <option value="dropdown">Veuillez selectionner une tâche
        <option value="Tache Analyse - Fondamentale">Tâche d'Analyse - Fondamentale
        <option value="Tache Analyse - Expression des besoins">Tâche d'Analyse - Expression des besoins
        <option value="Tache Analyse - Specification">Tâche d'Analyse - Spécification
        <option value="Tache de Conception - Fondamentale">Tâche de Conception - Fondamentale
        <option value="Tache de Conception - Conception Architecturale">Tâche de Conception - Conception Architecturale
        <option value="Tache de Conception - Conception detaillee">Tâche de Conception - Conception détaillée
        <option value="Tache de Réalisation - Fondamentale">Tâche de Réalisation - Fondamentale
        <option value="Tache de Réalisation - Choix du langage">Tâche de Réalisation - Choix du langage
        <option value="Tache de Tests - Fondamentale">Tâche de Tests - Fondamentale
        <option value="Tache de Tests - Technique du test">Tâche de Tests - Technique du test
    </select>
    ...
    <select name="contrainte">
        ...
        <option value="Reference">Référence
    ...
    <input type="submit" value="Poser problème" name="dropdown" id="dropdown" class ="button">
    </form>
