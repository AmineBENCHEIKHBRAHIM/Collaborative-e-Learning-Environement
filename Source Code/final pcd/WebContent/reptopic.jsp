			...
			if(messages != null && messages.size() != 0)
			{
				...
				if(Parents != null)
				{
					for(Message parent : Parents)
					{
						...
						if( msg ==mid.getIdMessage()){
%>
						<li class="comment_odd" id="ligneTopic<%= mid.getIdMessage() %>">
								<div class="author"><img class="avatar" src="images/demo/avatar.gif" width="32" height="32" alt="" /><span class="name">Par <%= parent.getTitre() %></span> </div>
...
<%
		...
		<div id="respond">
		<div>
				<h4><a href="#" onclick="messages('repondreMessage','<%= idParent  %>')">Ajouter une réponse</a></h4>
				<div id="divNouvMess"></div>
		</div>
		<%
