...
%>
	...
	<div id="content" class="clearfix">
		<%if(Integer.parseInt(session.getAttribute("iduser").toString())==18){ %><section id="left">
			...
			<h1>About Me:</h1>
			<p>Amine est un élève en 2ème année à l'Ecole Nationale des Sciences de l'informatique ( ENSI ) Spécialité ingénieurie logiciel et systèmes d'information.Il a passé deux ans de préparatoire à l'IPEIT où il a réussi a obtenir son diplome et Mathématiques et Sciences Physique fondamentaux.</p>
		</section><%}
		else {%>
